...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.addTab(self.tabCompras, "")
        self.tab_2 = QWidget()
        ...
        self.tableView.setGeometry(QRect(180, 140, 256, 192))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabCompras), QCoreApplication.translate("MainWindow", u"Compra de PCs", None))
